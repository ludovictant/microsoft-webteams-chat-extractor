...
1. Download `microsoft-teams-chat-extractor.zip` from the [dist/](https://github.com/ludovictant/microsoft-webteams-chat-extractor/tree/main/dist) folder.
...
4. Download `microsoft-teams-chat-extractor.zip` from the [dist/](https://github.com/ludovictant/microsoft-webteams-chat-extractor/tree/main/dist) folder.
