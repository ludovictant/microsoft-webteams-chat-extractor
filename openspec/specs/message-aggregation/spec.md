## Purpose
Provide efficient, real-time aggregation of conversation statistics (message counts and date ranges) directly from stored messages to power the history dashboard without redundant data storage.
