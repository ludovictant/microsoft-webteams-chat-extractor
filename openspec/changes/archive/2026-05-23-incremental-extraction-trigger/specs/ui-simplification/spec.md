...
- **AND** it SHALL display an informative tooltip on mouse hover: "Extract only new messages since the last crawl. Enable 'Local storage' below to use this feature."
